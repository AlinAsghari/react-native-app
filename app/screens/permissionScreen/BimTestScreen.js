...
//import { creatStackNavigator } from '@react-navigation/native';
import { createStackNavigator } from '@react-navigation/stack';
import { createBottomTabNavigator } from '@react-navigation/bottom-tabs';
import { Button } from 'react-native-web';
//import BimAccountScreen from '../accountSceen/BimAccountScreen';

global.SCREEN_TWEETS = 'Screen1';
global.SCREEN_TWEETDETAIL = 'Screen2';

function BimTestScreen() {
  const LinkToTweetDetail = () => {
    const navigation = useNavigation()
    const route = useRoute()
    return (
      <BimButton text="show tweet details " onPress={() => navigation.push(global.SCREEN_TWEETDETAIL , 
        {  
  ...
  const TabNavigator = () => (
    <Tab.Navigator>
        <Tab.Screen  name={global.SCREEN_TWEETDETAIL} component={TweetDetails}   />
        <Tab.Screen  name={global.SCREEN_TWEETS} component={Tweets}   />
    </Tab.Navigator>
  )
